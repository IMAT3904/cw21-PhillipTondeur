...
namespace Engine
{
	...
	public:
		...
		inline typename std::vector<BufferElement>::iterator begin() { return m_elements.begin(); }
		inline typename std::vector<BufferElement>::iterator end() { return m_elements.end(); }
		inline typename std::vector<BufferElement>::const_iterator begin() const { return m_elements.begin(); }
		inline  typename std::vector<BufferElement>::const_iterator end() const { return m_elements.end(); }
